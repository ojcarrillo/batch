...
@EnableJpaRepositories(
        ...
        basePackages = {"com.conexia.batch.reporteador.data.repository"})
public class PostgresRepositoryConfig {
    ...
    @Value("${postgres.datasource.hibernate.dialect}")
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        emf.setPackagesToScan("com.conexia.batch.reporteador.data.entity");   // <- package for entities
