...
@RestController
@RequestMapping("/realizarconsulta")
public class RealizarConsultaController {
	...
	@GetMapping
	public BatchStatus realizarConsulta() throws JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException, JobParametersInvalidException {
